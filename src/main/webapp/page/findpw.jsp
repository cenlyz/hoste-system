...
<link rel="stylesheet" href="page/find.css">
...
<form name="from" id=from1 action="findpwjsp.do" method="post"  >
	<div class="concent">
		<h1>找回密码</h1>
		<ul class="sendpwd">
			...
			<li>
				...
				<p>用户账号</p>
				<input id="r_email" name="id" type="text"	placeholder="请输入手机号" value="${id}" class="mailbg" onblur="user1(); " >
			</li>
			<li>
